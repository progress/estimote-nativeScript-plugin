...
var Simctl = (function () {
    ...
    Simctl.prototype.launch = function (deviceId, applicationIdentifier) {
        var _this = this;
        return (function () {
            var args = [];
    ...
    Simctl.prototype.uninstall = function (deviceId, applicationIdentifier) {
    ...
    Simctl.prototype.getAppContainer = function (deviceId, applicationIdentifier) {
        var _this = this;
        return (function () {
            try {
                return _this.simctlExec("get_app_container", [deviceId, applicationIdentifier]).wait();
            }
            catch (e) {

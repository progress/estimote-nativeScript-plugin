...
var ButtonStyler = (function () {
    ...
    ButtonStyler.registerHandlers = function () {
        ...
        style.registerHandler(style.textTransformProperty, new stylersCommon.StylePropertyChangedHandler(ButtonStyler.setTextTransformProperty, ButtonStyler.resetTextTransformProperty), "Button");
...
var LabelStyler = (function () {
    ...
    LabelStyler.registerHandlers = function () {
        style.registerHandler(style.backgroundInternalProperty, new stylersCommon.StylePropertyChangedHandler(LabelStyler.setBackgroundInternalProperty, LabelStyler.resetBackgroundInternalProperty, LabelStyler.getNativeBackgroundInternalValue), "Label");
    };
    return LabelStyler;
})();
...
var TextBaseStyler = (function () {
    ...
    TextBaseStyler.registerHandlers = function () {
        ...
        style.registerHandler(style.textTransformProperty, new stylersCommon.StylePropertyChangedHandler(TextBaseStyler.setTextTransformProperty, TextBaseStyler.resetTextTransformProperty), "TextBase");
...
var TabViewStyler = (function () {
    ...
    TabViewStyler.getNativeFontValue = function (view) {
        var tab = view;
        var currentFont;
    ...
    TabViewStyler.registerHandlers = function () {
        ...
        style.registerHandler(style.fontInternalProperty, new stylersCommon.StylePropertyChangedHandler(TabViewStyler.setFontInternalProperty, TabViewStyler.resetFontInternalProperty, TabViewStyler.getNativeFontValue), "TabView");
    };
...
function setTextTransform(view, value) {
    var str = getNSStringFromView(view);
    var result;
    switch (value) {
    ...
    var newStr = getAttributedStringFromView(view, result);
    if (newStr) {
...
function getNSStringFromView(view) {
    var result;
    if (view instanceof UIButton) {
        var attrTitle = view.titleLabel.attributedText;
        result = attrTitle ? attrTitle.string : view.titleLabel.text;
    }
    else {
        var attrText = view.attributedText;
        result = attrText ? attrText.string : view.text;
    }
    return NSString.alloc().initWithString(result || "");
}
function setStringToView(view, str) {
    if (view instanceof UIButton) {
        view.setTitleForState(str, UIControlState.UIControlStateNormal);
    }
    else {
        view.text = str;
    }
}
function getAttributedStringFromView(view, value) {
    var result;
    if (view instanceof UIButton) {
        var attrTitle = view.titleLabel.attributedText;
        if (attrTitle) {
...
function setAttributedStringToView(view, str) {
    if (view instanceof UIButton) {
        view.setAttributedTitleForState(str, UIControlState.UIControlStateNormal);
    }
    else {
